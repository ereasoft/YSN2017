...
Ext.define('Ysn.view.sampleproduction.completList',{
    extend: 'Ext.grid.Panel',
    xtype: 'completList',
    requires: [
        'Ysn.view.sampleproduction.completListController', 
		'Ysn.store.subSampleProductionList',
		'Ext.grid.filters.Filters' 
    ],
    
    controller: 'sampleproduction-completList',     
	store: {
        type: 'sampleProductionList3'
    }, 
...
Ext.define('Ysn.view.sampleproduction.completDetail',{
    extend: 'Ext.form.Panel',
    xtype: 'sampleproduction-completDetail',
    requires: [
        'Ysn.view.sampleproduction.completDetailController'
    ],

    controller: 'sampleproduction-completDetail', 


    frame: true,
    id: 'completDetail',
	reference: 'completDetail',
    bodyPadding: 10,
    scrollable:true,
    width: 900,   
    reader: {
    ...
    items: [{
        ...
        items: [
					...
					{   						 
                        ...
                        items: [{ xtype: 'numberfield', minValue:0, width:150, name: 'smp_rqty', allowDecimals: false, margin: '0 5 0 0'},
								...
								{ xtype: 'numberfield', minValue:0, width:150, name: 'smp_rqty2',allowDecimals: false}]
                    },
        ...
        items: [    
					...
					{ fieldLabel: Locale.getMsg('제작수량'), xtype: 'numberfield', minValue: 1, labelWidth: 100, allowDecimals: false, name: 'smp_qty', reference: 'smp_qty', readOnly: false },
                    ...
                    {
                        xtype: 'combobox',
                        reference: 'delay_comment_cd',
                        publishes: 'value',
                        fieldLabel: Locale.getMsg('지연사유'),
                        labelWidth: 100,
                        labelAlign: 'right',
                        displayField: 'CODE_NM',
                        valueField: 'CODE_ID',
                        name: 'delay_comment_cd',
                        anchor: '-15',
                        store: {
                            type: 'Tcode'
                        },
                    ...
                    { fieldLabel: Locale.getMsg('2차완료예정일'), xtype: 'datefield', labelWidth: 100, format: 'Y-m-d', name: 'prdt_pdate2', readOnly: false },
					{ fieldLabel: Locale.getMsg('제작지시사항'), colspan:3, xtype: 'textareafield', labelWidth: 100, name: 'prdt_cmt', readOnly: false, style:{width:'100%'}}
        ]
    },{
        xtype: 'fieldset',
		scrollable:true,
        ...
        dockedItems: [{
            ...
            items: [
                ...
                { xtype: 'hiddenfield', name: 'mode', value: 'C' },
                {
				...
				{ xtype: 'button', text: '제작완료취소', margin: '5 5 5 5', itemId:'btn1', hidden: true,
                    listeners: {click : 'onCancel'}
                },
				{ xtype: 'button', text: '제작완료', margin: '5 5 5 5', itemId:'btn2', hidden: true,
				listeners: { click: 'onComplete' }
                },
                { xtype: 'button', text: '제작지연', margin: '5 5 5 5', itemId:'btn4', hidden : true,
                    listeners: {click : 'onDelay'}
                },
				{ xtype: 'button', text: '사양확정', margin: '5 5 5 5', itemId:'btn3', hidden: true,
                    listeners: {click : 'onReceipt'}
				},
                {
                    xtype: 'button', text: '후가공', margin: '5 5 5 5', itemId: 'btn5', hidden: false,
                    listeners: { click: 'onChgStep' }
                }
            ]
        }]
});
