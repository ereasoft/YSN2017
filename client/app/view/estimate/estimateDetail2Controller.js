Ext.define( 'Ysn.view.estimate.estimateDetail2Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.estimateDetail2',
    ...
    chgType: function ( obj, newValue, oldValue, eOpts )
    {
        ...
        Ysn.Global.setFormType( newValue);
        if ( formLang == 'kr' )
        {
    ...
    openWindow: function ()
    {
        ...
        hidfield.setValue( 'estimateDetail2' );
        Ext.getCmp( 'estimateDetail2' ).add( win );
