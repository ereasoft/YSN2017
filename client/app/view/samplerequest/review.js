Ext.define('Ysn.view.samplerequest.reviewsearch',{
    extend: 'Ext.panel.Panel',
	xtype: 'review-search',

    requires: [
        'Ysn.view.samplerequest.reviewsearchController', 
	  	'Ysn.view.common.searchcustomer',
	    'Ysn.store.*'
    ],

    controller: 'review-search', 
...
Ext.define('Ysn.view.samplerequest.review',{
    extend: 'Ext.panel.Panel',
    xtype: 'samplerequest-review',
    requires: [
        'Ysn.view.samplerequest.reviewController', 
		'Ysn.view.common.searchcustomer'
    ],

    controller: 'samplerequest-review',
    reference: 'samplerequest-review',
	id:'samplerequest-review',
    layout: 'border',
    width: 500,
    height: 400,
    overflow:'hidden',
