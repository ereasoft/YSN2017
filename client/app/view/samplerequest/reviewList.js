...
Ext.define('Ysn.view.samplerequest.reviewList',{
    extend: 'Ext.grid.Panel',
    xtype: 'reviewList',
    requires: [
        'Ysn.view.samplerequest.reviewListController', 
		'Ysn.store.customerList',
		'Ext.grid.filters.Filters' 
    ],
    
    controller: 'samplerequest-reviewList',     
	store: {
        type: 'sampleReviewList', 
		autoLoad: false,
        autoDestroy: true
    }, 
...
Ext.define('Ysn.view.samplerequest.reviewDetail',{
    extend: 'Ext.form.Panel',
    xtype: 'samplerequest-reviewDetail',
    requires: [
        'Ysn.view.samplerequest.reviewDetailController'
    ],

    controller: 'samplerequest-reviewDetail', 


    frame: true,
    id: 'reviewDetail',
	reference: 'reviewDetail',
    bodyPadding: 10,
    scrollable:true,
    width: 1000,   
    reader: {
    ...
    items: [{
        ...
        items: [
					...
					{ fieldLabel: Locale.getMsg('요청일'), xtype: 'datefield', labelWidth: 100, width:230, format: 'Y-m-d', name: 'smr_rqdate', readOnly: true, disabled: true},					
					...
					{ fieldLabel: Locale.getMsg('접수일'), xtype: 'datefield', labelWidth: 100, width:230,  format: 'Y-m-d', name: 'smr_rrdate',readOnly: true, disabled: true},
                    ...
                    { fieldLabel: Locale.getMsg('프로젝트정보 및 특이사항'), colspan: '3', xtype: 'textareafield', readOnly:false, labelWidth: 80, style: { width: '100%', height: '200px' }, name: 'smr_comment' }
        ]
    },{
        xtype: 'fieldset',
		scrollable:true,
        ...
        dockedItems: [{
            ...
            items: [
				...
				{ xtype: 'hiddenfield', name: 'mode', value: 'V' },
                {
                    xtype: 'button', text: Locale.getMsg('PRINT'), itemId: 'print', hidden: true,
                    handler: 'print'
                },
				{ xtype: 'button', text: Locale.getMsg('검토반려'), itemId: 'btn1', margin: '5 5 5 5',
				listeners: { click: 'onReturnNew' }
				},
				{
				    xtype: 'button', text: Locale.getMsg('검토승인'), itemId: 'btn2', margin: '5 5 5 5',
				    listeners: { click: 'onSubmit1' }
				},
                {
