...
Ext.define('Ysn.view.samplerequest.receiptList',{
    extend: 'Ext.grid.Panel',
    xtype: 'receiptList',
    requires: [
        'Ysn.view.samplerequest.receiptListController', 
		'Ysn.store.customerList',
		'Ext.grid.filters.Filters' 
    ],
    
    controller: 'samplerequest-receiptList',     
	store: {
        type: 'sampleReceiptList', 
		autoLoad: false,
        autoDestroy: true
    }, 
...
Ext.define('Ysn.view.samplerequest.receiptDetail',{
    extend: 'Ext.form.Panel',
    xtype: 'samplerequest-receiptDetail',
    requires: [
        'Ysn.view.samplerequest.receiptDetailController'
    ],

    controller: 'samplerequest-receiptDetail', 
    ...
    items: [{
        ...
        items: [
                    ...
                    { fieldLabel: Locale.getMsg('차수'), border: true, xtype: 'textfield',labelWidth: 100, width: 150, name: 'smr_chasu', readOnly: true },
					{ fieldLabel: Locale.getMsg('영업담당'), xtype: 'textfield',labelWidth: 80, name: 'qruser_nm', readOnly: true},
					{ fieldLabel: Locale.getMsg('영업담당ID'),xtype: 'hiddenfield',name: 'qruser_cd', value: loginUser},
                    { fieldLabel: Locale.getMsg('샘플완료요청일'), xtype: 'datefield', labelWidth: 100, width:230, format: 'Y-m-d', name: 'smr_crdate',readOnly: true},
					...
					{ fieldLabel: '*'+Locale.getMsg('발주예정일'), xtype: 'datefield', labelWidth: 100, width:230, format: 'Y-m-d', name: 'smr_podate',readOnly: true},
				    {                         
                        rowspan: 2,
						xtype: 'fieldcontainer',
					...
					{ fieldLabel: '*'+Locale.getMsg('배송지'), xtype: 'textareafield', labelWidth: 80, style:{width:'100%',height:'100%'}, name: 'ship_to_adrs', rowspan:2, colspan:2 },
					{ fieldLabel: Locale.getMsg('송장번호'), xtype: 'textareafield', labelWidth: 80, style:{width:'100%'}, name: 'tracking_num', rowspan:2   },
					{ fieldLabel: Locale.getMsg('수령일'),xtype: 'datefield', labelWidth: 100, width:230, format: 'Y-m-d', name: 'smr_prdate',readOnly: true  },					
					{ fieldLabel: Locale.getMsg('초도선적요청일'), xtype: 'datefield', labelWidth: 100, width: 230, format: 'Y-m-d', name: 'smr_orderdate', readOnly: true },
        ...
        items: [                       
					...
					{ fieldLabel: Locale.getMsg('인쇄필름번호'), xtype: 'textfield', name: 'artwork_no', width: 600, reference : 'artwork_no', itemId : 'artwork_no', readOnly: false},
					{ fieldLabel: 'Packing info', xtype: 'textfield', name: 'packing_info', readOnly: false,
						xtype: 'combobox',
        ...
        dockedItems: [{
            ...
            items: [
				...
				{ xtype: 'button', text: Locale.getMsg('요청반려'), margin: '5 5 5 5', itemId: 'btn1', hidden:true,
				listeners: { click: 'onReturnNew' }
                },
				{ xtype: 'button', text: Locale.getMsg('요청접수'), margin: '5 5 5 5', itemId: 'btn2', hidden:true,
                    listeners: {click : 'onSubmit2'}
				}, 
                {
                    xtype: 'button', text: Locale.getMsg('정보수정'), itemId: 'btn3', margin: '5 5 5 5',
