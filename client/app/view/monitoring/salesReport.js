Ext.define('Ysn.view.monitoring.msalesReportsearch', {
    extend: 'Ext.panel.Panel',
    xtype: 'msalesReport-search',

    requires: [
        'Ysn.view.monitoring.msalesReportsearchController' 
    ],

    controller: 'msalesReport-search',
...
Ext.define('Ysn.view.monitoring.msalesReportsearchController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.msalesReport-search',
    init: function () {
        var Today = new Date();
    ...
    onSearch: function () {
        ...
        var pl = Ext.getCmp('monitoringmsalesReport');
        switch (el) {
            case '누계':
        ...
        Ext.getStore('msalesReport').load(
            {
                params: {
...
Ext.define('Ysn.store.msalesReport', {
    extend: 'Ext.data.Store',
    alias: 'store.msalesReport',
    storeId: 'msalesReport',
    fields: ['LIST1', 'MBOCHART', 'LIST2_1', 'LIST2_2', 'LIST3', 'CHART1', 'CHART2', 'CHART3', 'CHART4'],
    proxy: {
        method: "POST",
        type: 'ajax',
        url: '/Monitoring/salesReport',
        reader: {
            type: 'json',
            rootProperty: ''
        }
...
Ext.define('Ysn.view.monitoring.msalesReport', {
    extend: 'Ext.panel.Panel',
    xtype: 'monitoring-msalesReport',
    requires: [
        'Ysn.view.monitoring.msalesReportController',
		'Ext.chart.series.*',
		'Ext.chart.theme.Muted'
    ],

    controller: 'monitoring-msalesReport',
    reference: 'monitoringmsalesReport',
    id: 'monitoringmsalesReport',
    overflow: 'hidden',
    scrollable: false,
    header: false,
    bodyBorder: true,
...
Ext.define('Ysn.view.monitoring.msalesReportController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.monitoring-msalesReport',
    requires: [
    ],
    init: function () {
        this.lookupReference('msalesReportSearch').getController('msalesReport-search').onSearch();
    },
